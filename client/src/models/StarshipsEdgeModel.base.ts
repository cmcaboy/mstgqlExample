...
/**
 * StarshipsEdgeBase
 * auto generated base class for the model StarshipsEdgeModel.
 *
 * An edge in a connection.
 */
export const StarshipsEdgeModelBase = withTypedRefs<Refs>()(ModelBase
  .named('StarshipsEdge')
  .props({
    __typename: types.optional(types.literal("StarshipsEdge"), "StarshipsEdge"),
...
export class StarshipsEdgeModelSelector extends QueryBuilder {
...
export function selectFromStarshipsEdge() {
  return new StarshipsEdgeModelSelector()
}

export const starshipsEdgeModelPrimitives = selectFromStarshipsEdge().cursor
