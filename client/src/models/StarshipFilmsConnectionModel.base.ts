...
import { StarshipFilmsEdgeModelSelector } from "./StarshipFilmsEdgeModel.base"
...
/**
 * StarshipFilmsConnectionBase
 * auto generated base class for the model StarshipFilmsConnectionModel.
 *
 * A connection to a list of items.
 */
export const StarshipFilmsConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('StarshipFilmsConnection')
  .props({
    __typename: types.optional(types.literal("StarshipFilmsConnection"), "StarshipFilmsConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => StarshipFilmsEdgeModel)))),
...
export class StarshipFilmsConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | StarshipFilmsEdgeModelSelector | ((selector: StarshipFilmsEdgeModelSelector) => StarshipFilmsEdgeModelSelector)) { return this.__child(`edges`, StarshipFilmsEdgeModelSelector, builder) }
...
export function selectFromStarshipFilmsConnection() {
  return new StarshipFilmsConnectionModelSelector()
}

export const starshipFilmsConnectionModelPrimitives = selectFromStarshipFilmsConnection().totalCount
