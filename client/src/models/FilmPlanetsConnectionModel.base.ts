...
import { FilmPlanetsEdgeModelSelector } from "./FilmPlanetsEdgeModel.base"
...
/**
 * FilmPlanetsConnectionBase
 * auto generated base class for the model FilmPlanetsConnectionModel.
 *
 * A connection to a list of items.
 */
export const FilmPlanetsConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('FilmPlanetsConnection')
  .props({
    __typename: types.optional(types.literal("FilmPlanetsConnection"), "FilmPlanetsConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => FilmPlanetsEdgeModel)))),
    ...
    planets: types.union(types.undefined, types.null, types.array(types.union(types.null, MSTGQLRef(types.late((): any => PlanetModel))))),
  })
  .views(self => ({
    get store() {
...
export class FilmPlanetsConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | FilmPlanetsEdgeModelSelector | ((selector: FilmPlanetsEdgeModelSelector) => FilmPlanetsEdgeModelSelector)) { return this.__child(`edges`, FilmPlanetsEdgeModelSelector, builder) }
...
export function selectFromFilmPlanetsConnection() {
  return new FilmPlanetsConnectionModelSelector()
}

export const filmPlanetsConnectionModelPrimitives = selectFromFilmPlanetsConnection().totalCount
