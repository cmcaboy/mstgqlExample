...
/**
 * PeopleEdgeBase
 * auto generated base class for the model PeopleEdgeModel.
 *
 * An edge in a connection.
 */
export const PeopleEdgeModelBase = withTypedRefs<Refs>()(ModelBase
  .named('PeopleEdge')
  .props({
    __typename: types.optional(types.literal("PeopleEdge"), "PeopleEdge"),
...
export class PeopleEdgeModelSelector extends QueryBuilder {
...
export function selectFromPeopleEdge() {
  return new PeopleEdgeModelSelector()
}

export const peopleEdgeModelPrimitives = selectFromPeopleEdge().cursor
