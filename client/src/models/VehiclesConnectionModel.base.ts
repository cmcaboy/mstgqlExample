...
import { VehiclesEdgeModelSelector } from "./VehiclesEdgeModel.base"
...
/**
 * VehiclesConnectionBase
 * auto generated base class for the model VehiclesConnectionModel.
 *
 * A connection to a list of items.
 */
export const VehiclesConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('VehiclesConnection')
  .props({
    __typename: types.optional(types.literal("VehiclesConnection"), "VehiclesConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => VehiclesEdgeModel)))),
...
export class VehiclesConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | VehiclesEdgeModelSelector | ((selector: VehiclesEdgeModelSelector) => VehiclesEdgeModelSelector)) { return this.__child(`edges`, VehiclesEdgeModelSelector, builder) }
...
export function selectFromVehiclesConnection() {
  return new VehiclesConnectionModelSelector()
}

export const vehiclesConnectionModelPrimitives = selectFromVehiclesConnection().totalCount
