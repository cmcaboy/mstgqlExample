...
import { PeopleEdgeModelSelector } from "./PeopleEdgeModel.base"
...
/**
 * PeopleConnectionBase
 * auto generated base class for the model PeopleConnectionModel.
 *
 * A connection to a list of items.
 */
export const PeopleConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('PeopleConnection')
  .props({
    __typename: types.optional(types.literal("PeopleConnection"), "PeopleConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => PeopleEdgeModel)))),
...
export class PeopleConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | PeopleEdgeModelSelector | ((selector: PeopleEdgeModelSelector) => PeopleEdgeModelSelector)) { return this.__child(`edges`, PeopleEdgeModelSelector, builder) }
...
export function selectFromPeopleConnection() {
  return new PeopleConnectionModelSelector()
}

export const peopleConnectionModelPrimitives = selectFromPeopleConnection().totalCount
