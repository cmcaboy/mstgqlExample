...
import { FilmsEdgeModelSelector } from "./FilmsEdgeModel.base"
...
/**
 * FilmsConnectionBase
 * auto generated base class for the model FilmsConnectionModel.
 *
 * A connection to a list of items.
 */
export const FilmsConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('FilmsConnection')
  .props({
    __typename: types.optional(types.literal("FilmsConnection"), "FilmsConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => FilmsEdgeModel)))),
...
export class FilmsConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | FilmsEdgeModelSelector | ((selector: FilmsEdgeModelSelector) => FilmsEdgeModelSelector)) { return this.__child(`edges`, FilmsEdgeModelSelector, builder) }
...
export function selectFromFilmsConnection() {
  return new FilmsConnectionModelSelector()
}

export const filmsConnectionModelPrimitives = selectFromFilmsConnection().totalCount
