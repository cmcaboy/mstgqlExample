...
import { SpeciesEdgeModelSelector } from "./SpeciesEdgeModel.base"
...
/**
 * SpeciesConnectionBase
 * auto generated base class for the model SpeciesConnectionModel.
 *
 * A connection to a list of items.
 */
export const SpeciesConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('SpeciesConnection')
  .props({
    __typename: types.optional(types.literal("SpeciesConnection"), "SpeciesConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => SpeciesEdgeModel)))),
...
export class SpeciesConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | SpeciesEdgeModelSelector | ((selector: SpeciesEdgeModelSelector) => SpeciesEdgeModelSelector)) { return this.__child(`edges`, SpeciesEdgeModelSelector, builder) }
...
export function selectFromSpeciesConnection() {
  return new SpeciesConnectionModelSelector()
}

export const speciesConnectionModelPrimitives = selectFromSpeciesConnection().totalCount
