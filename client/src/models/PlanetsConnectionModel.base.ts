...
import { PlanetsEdgeModelSelector } from "./PlanetsEdgeModel.base"
...
/**
 * PlanetsConnectionBase
 * auto generated base class for the model PlanetsConnectionModel.
 *
 * A connection to a list of items.
 */
export const PlanetsConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('PlanetsConnection')
  .props({
    __typename: types.optional(types.literal("PlanetsConnection"), "PlanetsConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.union(types.null, types.late((): any => PlanetsEdgeModel)))),
...
export class PlanetsConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | PlanetsEdgeModelSelector | ((selector: PlanetsEdgeModelSelector) => PlanetsEdgeModelSelector)) { return this.__child(`edges`, PlanetsEdgeModelSelector, builder) }
...
export function selectFromPlanetsConnection() {
  return new PlanetsConnectionModelSelector()
}

export const planetsConnectionModelPrimitives = selectFromPlanetsConnection().totalCount
